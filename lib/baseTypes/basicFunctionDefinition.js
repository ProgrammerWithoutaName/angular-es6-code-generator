...
const functionImplementationTemplate = require('./implementationTemplates/functionImplementationTemplate');
const functionDeclarationTemplate = require('./implementationTemplates/functionDeclarationTemplate');

const needsTypeDefinition = new Set(['controller', 'service']);
