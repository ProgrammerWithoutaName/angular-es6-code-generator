...
describe('basicFunctionDefinition', () => {
    ...
    beforeEach(() => {
        ...
        basicFunctionDefinition = proxyquire('./basicFunctionDefinition', {
            ...
            './implementationTemplates/functionImplementationTemplate': inputs.mockFunctionImplementationTemplate,
            './implementationTemplates/functionDeclarationTemplate': inputs.mockFunctionDeclarationTemplate,
