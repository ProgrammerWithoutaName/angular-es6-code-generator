...
describe('functionImplementationTemplate', () => {
    let functionImplementationTemplate, inputs;//= require('./functionImplementationTemplate');
    ...
    beforeEach(() => {
        ...
        functionImplementationTemplate = proxyquire('./functionImplementationTemplate', {
...
parentModule.module.controller(implementationKey, Foo);`;
    ...
    describe('dependencyDeclarations.format call', () => {
        ...
        beforeEach(() => {
            ...
            functionImplementationTemplate.format(givenOptions);
